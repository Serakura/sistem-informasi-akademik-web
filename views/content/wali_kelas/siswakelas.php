<div class="table-responsive border px-2 py-4">
    <table class="table table-bordered table-hover table-striped " id="data-table">
        ...
        <tbody>
            ...
            $query = "SELECT *, wali_kelas.nama FROM kelas INNER JOIN wali_kelas ON wali_kelas.id_wali = kelas.id_wali WHERE wali_kelas.nip='s$nip' GROUP BY kelas.kode_kelas ORDER BY nama_kelas ASC";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?page=siswa&kode_kelas=<?php echo $d['kode_kelas'] ?>" class="btn btn-primary"><i class="fas fa-fw fa-eye mr-2"></i>Lihat Siswa</a>
                    </td>
                </tr>
                <!-- Update Data Guru -->
