    ...
    <table class="table table-bordered table-hover table-striped " id="data-table">
        <thead style="background-color: #4e73df;">
            <tr class="text-light">
                ...
                <th scope="col">Data Mata Pelajaran</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?page=matapelajaran&kode_kelas=<?php echo $d['kode_kelas'] ?>" class="btn btn-primary"><i class="fas fa-fw fa-eye mr-2"></i>Lihat Mata Pelajaran</a>
                    </td>
                </tr>
                <!-- Update Data Guru -->
