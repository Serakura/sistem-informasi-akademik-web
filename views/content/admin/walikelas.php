<div class="container-fluid p-1">
    <div class="d-flex justify-content-between">
        <a href="./content/admin/function/downloaddatawalikelas.php" type="button" class="btn btn-primary mb-2 mr-2 "><i class="fas fa-fw fa-print mr-2"></i>Download Data Wali Kelas</a>
        <button type="button" class="btn btn-primary mb-2" data-toggle="modal" style="float:right;" data-target="#tambahdatawali" data-whatever="Guru">Tambah Data Wali Kelas</button>
    </div>
</div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a data-toggle="modal" data-target="#updatedatawali<?php echo $d['nip'] ?>" class="link"><img name="pencil" src="../assets/edit.png"></a>
                        <a href="./content/admin/function/hapuswali.php?nip=<?php echo $d['nip'] ?>&foto=<?php echo $d['foto'] ?>" class="link"><img name="delete" src="../assets/delete.png" onclick="return confirm('Yakin Akan di Hapus ?')"></a>
                    </td>
                </tr>
                <!-- Update Data Guru -->
                <div class="modal fade" id="updatedatawali<?php echo $d['nip'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Update Data Wali Kelas</h5>
                            ...
                            ?>
                                <div class="modal-body">
                                    <form action="./content/admin/function/updatewali.php" method="POST" enctype="multipart/form-data">
