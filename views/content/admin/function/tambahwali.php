...
$cek_nip = mysqli_query($koneksi, "SELECT * FROM wali_kelas WHERE nip='$nip'");

if (mysqli_num_rows($cek_nip) > 0) {
?>
    <script>
        window.location = '../../../index.php?page=walikelas&msg=Gagal menambahkan data wali kelas karena NIP sudah digunakan';
    </script>
...
<?php
    ...
    if ($gambar == null) {
        $query = mysqli_query($koneksi, "INSERT INTO wali_kelas 
        ...
        echo "
        <script>
        window.location='../../../index.php?page=walikelas&msg=Berhasil menambahkan data wali kelas';
        </script>
        ";
    } else {
        ...
        if ($ekstensifile != 'png' && $ekstensifile != 'jpg' && $ekstensifile != 'jpeg') {
            echo "<script>
            window.location='../../../index.php?page=walikelas&msg=Gagal menambahkan data wali kelas karena format gambar tidak sesuai';
                </script>";
        } else {
            ...
            if ($pidah_folder) {
                ...
                echo "<script>
                    window.location='../../../index.php?page=walikelas&msg=Gagal menambahkan data wali kelas';
                </script>";
            }
        }
    }
